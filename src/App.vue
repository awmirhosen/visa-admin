...
import NavigationEditPost from "@/components/navigation/NavigationEditPost.vue";
...
watch(route, () => {
  ...
  switch (route.name) {
    ...
    case "pages" :
      pageStore.changeStatusNavigationMain(true)
      pageStore.changeStatusNavigationEditPost(false);
      break;

    case "editPage" :
      pageStore.changeStatusNavigationMain(false)
      pageStore.changeStatusNavigationEditPost(false);
      break;

      ///// if url was login set layout to false for changing layouts
    case "login" :
      pageStore.changeStatusNavigationMain(false)
      break;
