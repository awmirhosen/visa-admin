<template>
  <svg xmlns='http://www.w3.org/2000/svg' width='100%' height='100%' viewBox='0 0 1600 800'>
    ...
    <g fill-opacity='1'>
      ...
      <path fill='#D2F9FF' d='M1315.3 72.4c75.3-12.6 148.9-37.1 216.8-72.4h-723C966.8 71 1144.7 101 1315.3 72.4z'/>
    </g>
  </svg>
...
const submitLogin = () => {
  ...
  axios.post("/auths/token", formData).then((res) => {
    ...
    if (err.response.status == 401) {
      errorMessage.value = "Incorrect Username, Try Again"
      snackbar.value = true;
    }
  })
}
